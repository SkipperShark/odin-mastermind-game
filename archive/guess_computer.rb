...
class GuessComputer
  ...
  #   num_new_matches = num_matches - solution.size
  ...
  #   puts "Solution : #{solution}"
  # end
  #* user 88 algorithm - end


  #? swaszek algorithm - start
  def compute
    first_turn = guess_history.empty?
    if first_turn
  ...
  def calc_response(clue)
    ...
    # guess_options_static.each_with_index do |option, index|
    #   # puts "#{option}"
    ...
    #   if option[:index] == 1230
    #     puts "\n\n\inspection\n\n"
    #     puts "option : #{option}"
    #     puts "sim_guess : #{sim_guess}"
    #     puts "sim_secret : #{sim_secret}"
    #     puts "sim_clue : #{sim_clue}"
    #     puts "s_num_pos_matches : #{s_num_pos_matches}"
    #     puts "s_num_full_matches : #{s_num_full_matches}"
    #     puts "num_position_matches : #{num_position_matches}"
    #     puts "num_full_matches : #{num_full_matches}"
    #     puts "delete_guess : #{delete_guess}"
    #   end

    #   #todo this doesnt work, we are changing the array indexes as we are deleting it!!
  ...
  #? swaszek algorithm - end

  #! old version i cant remember
  # def calc_response(clue)
  #   puts "calc response"
  #   puts "current_option : #{current_option}".colorize(:cyan)
  #   puts "clue : #{clue}".colorize(:cyan)
  ...
  #     # puts "guess inspect : #{guess.inspect}".colorize(:cyan)
  #     # puts "guess : #{guess}".colorize(:cyan)
  #     self.current_option = guess_options.select { |option| option[:id] == "1122" }.first
